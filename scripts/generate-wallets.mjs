...
const agents = [
  ...
  { name: "seller-analyst",     port: 4507, envVar: "SELLER_SECRET_6" },
  { name: "seller-strategist",  port: 4508, envVar: "SELLER_SECRET_7" },
  { name: "seller-lawyer",      port: 4509, envVar: "SELLER_SECRET_8" },
  { name: "seller-marketer",    port: 4510, envVar: "SELLER_SECRET_9" },
  { name: "seller-monitor",     port: 4511, envVar: "SELLER_SECRET_10" },
